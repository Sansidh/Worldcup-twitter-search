# Core Engine for Ted-Recommender Search feature
...
# Perform classification on given query using Naive Bayes to returned belonged classes and its percentage
# The complete application is hosted at Ted-Recommender.com
